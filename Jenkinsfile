pipeline {
    ...
    parameters {
         string(name: 'tomcat_dev', defaultValue: '172.31.58.74', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '172.31.63.153', description: 'Production Server')
    }
